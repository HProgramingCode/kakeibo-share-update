        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SplitType = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SettlementTransfers_Settlements_SettlementId",
                        column: x => x.SettlementId,
                        principalTable: "Settlements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SettlementTransfers_Users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SettlementTransfers_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ShareRatio = table.Column<int>(type: "integer", nullable: true),
                    ShareAmount = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SettlementTransfers_FromUserId",
                table: "SettlementTransfers",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SettlementTransfers_SettlementId",
                table: "SettlementTransfers",
                column: "SettlementId");

            migrationBuilder.CreateIndex(
                name: "IX_SettlementTransfers_ToUserId",
                table: "SettlementTransfers",
                column: "ToUserId");
